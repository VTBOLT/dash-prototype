...
function nonrace_statesGPIO() { 
    ...
    rpio.poll(29, pollDischarge, rpio.POLL_UP);
    rpio.poll(31, pollPump, rpio.POLL_UP);
    rpio.poll(33, pollACC, rpio.POLL_UP);
    rpio.poll(35, pollIGN, rpio.POLL_UP);
    rpio.poll(37, pollISO, rpio.POLL_UP);  
}
